...
def procesar_datos(df_gp, df_ax):
    ...
    df_combinado = df_combinado[['Orden de Compra', 'Cantidad', 'Valor SKU Total', 'Fecha Trx', 'Fecha y hora de creación', 'Id de Origen', 'Dias_entre_GP_y_AX', 'Pedido de ventas', 'Categoria_Dias']]
